		...
		if ("${MissingBoard.dpchknum}" == "") {
			...
			for(let i in thumbAr) {
				if (thumbAr[i] != '') {
					...
					$(".fileContent").show();
					console.log(i+1);
					output += '<span id="imgPreview' + (i+1) + '" style="margin-right: 50px;"><img src="../resources/uploads' + thumbAr[i] + '" style="margin-right: 5px;" />' +
						'<img src="../resources/images/missing/cancel.png" style="width: 20px;" onclick="delImg(this);" /></span>';
			...
			for (let i in imgAr) {
				...
				if (imgAr[i] != '') {
					...
					'<img src="../resources/images/missing/cancel.png" style="width: 20px;" onclick="delUrlImg(this);" /></span>';
				...
				$.ajax({
					...
					success : function(data) { // 통신 성공시 수행될 콜백 함수
						...
						for(let i = 0; i < thumbImgs.length-1; i++) {
							output += '<span id="imgPreview' + (i+1) + '" style="margin-right: 50px;"><img src="../resources/uploads' + thumbImgs[i] + '" style="margin-right: 5px;" />' +
							'<img src="../resources/images/missing/cancel.png" style="width: 20px;" onclick="delImg(this);" /></span>';
