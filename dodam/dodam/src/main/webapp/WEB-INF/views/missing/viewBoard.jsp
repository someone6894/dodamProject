	...
	<script>
		$(function() {
			...
			for (let i=0; i<imgAr.length; i++) {
				if (imgAr[i] != "") {
					if (imgAr[i].split(":")[0] == "http") {
						...
						output += "<img src='../resources/uploads" + imgAr[i] + "' width='30%'/>";
					}
					imgCnt++;
				}
			}
			...
			for (let i=0; i<3-imgCnt; i++) {
				output += "<img src='../resources/images/missing/noimage.png' width='30%' />";
			}
...
<body>
	...
	<div class="container">
		<div class="wrap">
			<table>
				<tr>
					<td colspan="2"><h1 style="color: #ff7f00;">※ ${MissingBoard.title } ※</h1>
					<!-- <td></td> -->
				</tr>
				<tr>
					<td><div style="margin: 10px 0 20px 0;">${MissingBoard.writer } | <span id="registerdate"></span> |
					 조회 ${MissingBoard.readcount } | 좋아요 
					 <img src="../resources/images/missing/dislike.png" id="like" /> ${MissingBoard.likecount } </div>
					 <div id="foundBtn" onclick="chageToFound();">찾았어요!</div></td></td>
					<!-- <td></td> -->
				</tr>
				<tr class="img_tr">
