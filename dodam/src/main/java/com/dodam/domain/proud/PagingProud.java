...
public class PagingProud {
	private int postPerPage = 6; // 페이지당 글 갯수
	...
	public PagingProud(int postPerPage, int pageCntPerBlock, int totalPage, int startNum, int currentPagingBlock,
